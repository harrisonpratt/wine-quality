...
# - **Acidity**:
A medium amount of acidity can add freshness and structure to the wine. However, too much or too little acidity can unbalance the wine.
# - **pH Level**:
A pH level that is too low or too high can negatively impact the wine's taste, leading to a lower-quality wine.
# - **Residual Sugar**:
The right amount of residual sugar is crucial. Too much or too little can result in an imbalanced flavor profile.
...
variable_table <- data.frame(
  ...
  Measurement_Scale = c(
    ...
    "Ratio", "Ratio", "Ratio", "Interval", "Ratio",
  ...
  Description = c(
    "Tartaric acid level",
    "Acetic acid content (wine fault)",
    "Citric acid content",
    "Sugar left after fermentation",
    "Salt content",
    "Free SO₂ (preserves freshness)",
    "Total SO₂ (free + bound)",
    "Wine density",
    "Acidity level (inverse scale)",
    "Sulfate content (preservative)",
    "Alcohol content",
